...
public final class UsbHub extends AUsbDevice implements IUsbHub, IUsbPorts {
   ...
   */
  public UsbHub(final DeviceManager deviceManager, final DeviceId id, final DeviceId parentId, final int speed, final Device device) throws UsbPlatformException {
